...
async function deriveKey(secret) {
    ...
    return crypto.subtle.deriveKey({ name: 'PBKDF2', salt: enc.encode('dreams5-salt'), iterations: 100_000, hash: 'SHA-256' }, material, { name: 'AES-GCM', length: 256 }, false, ['encrypt', 'decrypt']);
}
...
export async function decryptJSON(b64, secret) {
